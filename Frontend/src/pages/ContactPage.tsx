...
import { Mail, Globe, MapPin, Clock, Share2, Image, MessageCircle, Briefcase, CheckCircle, Loader2 } from 'lucide-react'
    ...
    <div className="pt-16 lg:pt-20">
      ...
      <section className="py-20 bg-gradient-to-br from-[#0f766e] to-[#115e59]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="inline-block px-3 py-1 bg-white/20 text-white text-xs font-semibold rounded-full mb-4">Contact</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-5">
              {[
                ...
                { icon: Clock, title: 'Office Hours', content: 'Sat – Thu: 8:00 AM – 4:00 PM\nFriday: Closed' },
              ].map((item) => (
                <div key={item.title} className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 flex gap-4">
              ...
              <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                ...
                <div className="flex gap-2">
                  {[
                    ...
                    <a key={label} href={href} target="_blank" rel="noopener noreferrer" aria-label={label} className="w-9 h-9 rounded-xl bg-gray-50 hover:bg-[#0f766e] flex items-center justify-center transition-colors group">
            ...
            <div className="lg:col-span-2">
              {sent ? (
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-12 text-center">
                  ...
                  <p className="text-gray-500">Thank you for reaching out. Our team will respond within 24–48 hours.</p>
                </div>
              ) : (
