...
const values = [
  {
    icon: Users,
    title: "Youth Leadership & Ownership",
    desc: "Young people lead the work — as decision-makers, facilitators, and advocates, not just beneficiaries.",
  },
  {
    icon: ShieldCheck,
    title: "Peacebuilding & P/CVE",
    desc: "We work non-violently to reduce conflict and to prevent and counter violent extremism.",
  },
  {
    icon: Scale,
    title: "Gender Inclusion",
    desc: "We invest in young women leaders and make space for voices too often left out of peace and security.",
  },
  {
    icon: HeartHandshake,
    title: "Community Resilience & Dialogue",
    desc: "We bring youth, elders, women, and authorities together to build trust and solve problems locally.",
  },
  {
    icon: Handshake,
    title: "Partnership & Collaboration",
    desc: "We work with government, civil society, and international partners to reach further together.",
  },
];
      ...
      <section className="relative py-24 bg-[#0f766e] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/80 max-w-2xl mx-auto">
            YEEP Somalia is a youth-led NGO in Mogadishu, strengthening youth leadership in
            peacebuilding and preventing violent extremism across Somalia.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold text-gray-900 mt-2 mb-5">
                A Youth-Led Movement for Peace
              </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-500 leading-relaxed">
                "Youth are not just beneficiaries of change — we are the leaders of change. Youth
